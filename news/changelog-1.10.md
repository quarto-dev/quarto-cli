...
- ([#14577](https://github.com/quarto-dev/quarto-cli/issues/14577)): Fix a code comment being used as the title of an embedded notebook that has no markdown heading or title; the notebook filename is used instead.
