...
- ([#14664](https://github.com/quarto-dev/quarto-cli/pull/14664)): Fix Typst render failing with `path must not contain a backslash` when `bibliography` metadata used a relative path starting with a dot (e.g. `./refs.bib` or `../refs.bib`).
