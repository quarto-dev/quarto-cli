...
- ([#13847](https://github.com/quarto-dev/quarto-cli/pull/13847)): Correctly targets the `property` attribute instead of the `name` attribute for `og:site_name` meta tags, to ensure proper metadata markdown processing. (author: @mcanouil)
