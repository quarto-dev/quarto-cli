...
latex-makeindex-opts: ["--debug", "markup"]
---

The index for this document should have a lot of debug markup present in it.

Can also set debug option using:

`quarto render makeindex-custom.Rmd --makeindex-opt="--debug" --makeindex-opt="markup"`
