...
::: {.cell tbl-colwidths='[20,10,15,10,15,15,15,15,15,15,15,10]' execution_count=1}
``` {.python .cell-code}
import pandas as pd
...
Car Name               Fuel Cons. (mpg)    # Cylinders    Displ. (cu.in.)    Gross HP    Rear axle ratio    Weight (1000 lbs)    1/4 mile time    Engine    Trans.    # forward gears    # carburetors
-------------------  ------------------  -------------  -----------------  ----------  -----------------  -------------------  ---------------  --------  --------  -----------------  ---------------
