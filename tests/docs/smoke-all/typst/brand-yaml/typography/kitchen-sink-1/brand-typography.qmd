  ...
  tests:
    typst:
      ...
      -
        ...
        - 'Paragraph is rgb\("#080180"\) aguafina script extralight normal 14pt'
      ...
      -
        ...
        - '^#show raw.where\(block: false\): set text\(font: "Inconsolata", weight: 600, size: 0.57em, fill: rgb\(8, 111, 15\), \)$'
