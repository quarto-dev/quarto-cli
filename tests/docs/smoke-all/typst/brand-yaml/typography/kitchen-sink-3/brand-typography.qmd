  ...
  tests:
    typst:
      ...
      -
        ...
        - 'a link in gentium plus extralight italic\s*10\.5pt'
      - []
      ...
      -
        ...
        - '^#show text: content => underline\(content\)$'
        - '^#show text: content => highlight\(fill: rgb\(255, 105, 180\), content\)$'

        - 'heading-family: \("Raleway",\),$'
        - 'heading-weight: 500,$'
        - 'heading-style: "normal",$'
        - 'heading-color: unescape-eval\("rgb\(\\"\\#042f02\\"\)"\),$'
        - 'heading-background-color: unescape-eval\("rgb\(255, 105, 180\)"\).$'
        ...
        - '^#show raw.where\(block: false\): set text\(font: "Space Mono", weight: 400, style: "italic", size: 12pt, fill: rgb\(8, 111, 15\), \)$'
        - '^#show raw.where\(block: false\): content => highlight\(fill: rgb\(255, 250, 224\), content\)$'

        - '^#show raw.where\(block: true\): set text\(font: "Space Mono", weight: 400, style: "italic", size: 12pt, fill: rgb\("#eee"\), \)$'
        - '^#show raw.where\(block: true\): set block\(fill: rgb\("#0a3c07"\)\)$'

        - '^#show link: set text\(font: "Gentium Plus", weight: 200, style: "italic", size: 10.5pt, fill: maroon, \)$'
