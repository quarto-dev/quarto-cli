  ...
  tests:
    typst:
      ensureTypstFileRegexMatches:
        # All margin captions use top alignment (consistent with HTML visual behavior)
        - ['#note\(alignment: "top"', '#block\(breakable: false\)']
        - []
...
![CAP-FIG-ONE](test-image.png){#fig-one cap-location="margin"}
...
![CAP-FIG-TWO](test-image.png){#fig-two cap-location="margin"}
...
![CAP-FIG-THREE](test-image.png){#fig-three cap-location="margin"}
