...
![CAP-ALPHA in margin](test-image.png){#fig-alpha .column-margin width=100%}
...
![CAP-BETA in main](test-image.png){#fig-beta width=50%}
...
![CAP-GAMMA in margin](test-image.png){#fig-gamma .column-margin width=100%}
...
![CAP-DELTA in main](test-image.png){#fig-delta width=50%}
