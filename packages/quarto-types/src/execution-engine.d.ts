...
/**
 * Interface for implementing a Quarto execution engine
 * @deprecated Use ExecutionEngineDiscovery and LaunchedExecutionEngine instead
 */
export interface ExecutionEngine {
  /**
   * Initialize the engine with an EngineProjectContext
   * This is called before the engine is used
   *
   * @param context The restricted project context
   * @returns The engine instance (this)
   */
  initialize?: (context: EngineProjectContext) => ExecutionEngine;
