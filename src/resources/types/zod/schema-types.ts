...
export const ZodPandocFormatOutputFile = z.union([
  z.string(),
  z.enum(["null"] as const),
]);
...
export const ZodGiscusConfiguration = z.object({
  ...
  mapping: z.union([
    z.enum(['"pathname"', '"url"', '"title"', '"og:title"'] as const),
    z.string(),
  ]),
...
export const ZodBaseWebsite = z.object({
  ...
  navbar: z.union([
    ...
    z.object({
      ...
      pinned: z.boolean(),
      collapse: z.boolean(),
      "collapse-below": z.enum(
        ['"sm"', '"md"', '"lg"', '"xl"', '"xxl"'] as const,
      ),
...
export const ZodBrandNamedLogo = z.enum(
...
export const ZodBrandFontWeight = z.enum(
  [
    "100",
    "200",
    "300",
...
export const ZodBrandFontCommon = z.object({
  ...
  display: z.enum(
    ['"auto"', '"block"', '"swap"', '"fallback"', '"optional"'] as const,
  ),
}).strict().partial();
