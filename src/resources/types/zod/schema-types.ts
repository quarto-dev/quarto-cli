...
export const ZodFormatLanguage = z.object({
  ...
  "crossref-alg-title": z.string(),
  "crossref-axm-title": z.string(),
  "crossref-asm-title": z.string(),
  ...
  "crossref-alg-prefix": z.string(),
  "crossref-axm-prefix": z.string(),
  "crossref-asm-prefix": z.string(),
