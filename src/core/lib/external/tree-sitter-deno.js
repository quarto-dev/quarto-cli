...
let wasmInstantiatePromise = new Promise((resolve, reject) => {
  wasmInstantiateResolve = resolve;
});
    ...
    @param {boolean=} dontAddNull */
      ...
      assert(
        ...
        "INITIAL_MEMORY should be larger than TOTAL_STACK, was " +
          INITIAL_MEMORY + "! (TOTAL_STACK=" + TOTAL_STACK + ")",
      );
        ...
        for (var symName in exports) {
          ...
          if (replace || GOT[symName].value == 0) {
            if (typeof value === "function") {
              ...
              err(
                "unhandled export type for `" + symName + "`: " +
                  (typeof value),
              );
            }
          }
        ...
        try {
          ...
          console.error(
            "emscripten_realloc_buffer: Attempted to grow heap from " +
              buffer.byteLength + " bytes to " + size +
      ...
      var _ts_language_symbol_for_name =
        Module["_ts_language_symbol_for_name"] = createExportWrapper(
      ...
      var _ts_language_field_name_for_id =
        Module["_ts_language_field_name_for_id"] = createExportWrapper(
      ...
      /** @type {function(...*):?} */
      var _ts_parser_delete = Module["_ts_parser_delete"] = createExportWrapper(
        "ts_parser_delete",
      );
      ...
      /** @type {function(...*):?} */
      var _ts_parser_reset = Module["_ts_parser_reset"] = createExportWrapper(
        "ts_parser_reset",
      );
      ...
      var _ts_parser_set_timeout_micros =
        Module["_ts_parser_set_timeout_micros"] = createExportWrapper(
          "ts_parser_set_timeout_micros",
        );

      /** @type {function(...*):?} */
      var _ts_query_new = Module["_ts_query_new"] = createExportWrapper(
        "ts_query_new",
      );

      /** @type {function(...*):?} */
      var _ts_query_delete = Module["_ts_query_delete"] = createExportWrapper(
        "ts_query_delete",
      );
      ...
      var _ts_query_capture_name_for_id =
        Module["_ts_query_capture_name_for_id"] = createExportWrapper(
          "ts_query_capture_name_for_id",
        );

      /** @type {function(...*):?} */
      var _ts_query_string_value_for_id =
        Module["_ts_query_string_value_for_id"] = createExportWrapper(
          "ts_query_string_value_for_id",
        );

      /** @type {function(...*):?} */
      var _ts_query_predicates_for_pattern =
        Module["_ts_query_predicates_for_pattern"] = createExportWrapper(
      ...
      /** @type {function(...*):?} */
      var _ts_tree_copy = Module["_ts_tree_copy"] = createExportWrapper(
        "ts_tree_copy",
      );

      /** @type {function(...*):?} */
      var _ts_tree_delete = Module["_ts_tree_delete"] = createExportWrapper(
        "ts_tree_delete",
      );
      ...
      var _ts_parser_enable_logger_wasm =
        Module["_ts_parser_enable_logger_wasm"] = createExportWrapper(
      ...
      var _ts_language_type_is_named_wasm =
        Module["_ts_language_type_is_named_wasm"] = createExportWrapper(
          "ts_language_type_is_named_wasm",
        );

      /** @type {function(...*):?} */
      var _ts_language_type_is_visible_wasm =
        Module["_ts_language_type_is_visible_wasm"] = createExportWrapper(
      ...
      var _ts_tree_get_changed_ranges_wasm =
        Module["_ts_tree_get_changed_ranges_wasm"] = createExportWrapper(
      ...
      var _ts_tree_cursor_goto_first_child_wasm =
        Module["_ts_tree_cursor_goto_first_child_wasm"] = createExportWrapper(
          "ts_tree_cursor_goto_first_child_wasm",
        );

      /** @type {function(...*):?} */
      var _ts_tree_cursor_goto_next_sibling_wasm =
        Module["_ts_tree_cursor_goto_next_sibling_wasm"] = createExportWrapper(
      ...
      var _ts_tree_cursor_current_node_id_wasm =
        Module["_ts_tree_cursor_current_node_id_wasm"] = createExportWrapper(
          "ts_tree_cursor_current_node_id_wasm",
        );

      /** @type {function(...*):?} */
      var _ts_tree_cursor_start_position_wasm =
        Module["_ts_tree_cursor_start_position_wasm"] = createExportWrapper(
          "ts_tree_cursor_start_position_wasm",
        );

      /** @type {function(...*):?} */
      var _ts_tree_cursor_end_position_wasm =
        Module["_ts_tree_cursor_end_position_wasm"] = createExportWrapper(
          "ts_tree_cursor_end_position_wasm",
        );

      /** @type {function(...*):?} */
      var _ts_tree_cursor_start_index_wasm =
        Module["_ts_tree_cursor_start_index_wasm"] = createExportWrapper(
      ...
      var _ts_tree_cursor_current_field_id_wasm =
        Module["_ts_tree_cursor_current_field_id_wasm"] = createExportWrapper(
          "ts_tree_cursor_current_field_id_wasm",
        );

      /** @type {function(...*):?} */
      var _ts_tree_cursor_current_node_wasm =
        Module["_ts_tree_cursor_current_node_wasm"] = createExportWrapper(
      ...
      var _ts_node_named_child_count_wasm =
        Module["_ts_node_named_child_count_wasm"] = createExportWrapper(
      ...
      var _ts_node_child_by_field_id_wasm =
        Module["_ts_node_child_by_field_id_wasm"] = createExportWrapper(
      ...
      var _ts_node_next_named_sibling_wasm =
        Module["_ts_node_next_named_sibling_wasm"] = createExportWrapper(
          "ts_node_next_named_sibling_wasm",
        );

      /** @type {function(...*):?} */
      var _ts_node_prev_named_sibling_wasm =
        Module["_ts_node_prev_named_sibling_wasm"] = createExportWrapper(
      ...
      var _ts_node_descendant_for_index_wasm =
        Module["_ts_node_descendant_for_index_wasm"] = createExportWrapper(
      ...
      var _ts_node_descendant_for_position_wasm =
        Module["_ts_node_descendant_for_position_wasm"] = createExportWrapper(
      ...
      var _ts_node_named_children_wasm =
        Module["_ts_node_named_children_wasm"] = createExportWrapper(
          "ts_node_named_children_wasm",
        );

      /** @type {function(...*):?} */
      var _ts_node_descendants_of_type_wasm =
        Module["_ts_node_descendants_of_type_wasm"] = createExportWrapper(
      ...
      var _orig$ts_parser_timeout_micros =
        Module["_orig$ts_parser_timeout_micros"] = createExportWrapper(
          "orig$ts_parser_timeout_micros",
        );

      /** @type {function(...*):?} */
      var _orig$ts_parser_set_timeout_micros =
        Module["_orig$ts_parser_set_timeout_micros"] = createExportWrapper(
      ...
      function exit(status, implicit) {
        ...
        if (keepRuntimeAlive()) {
          ...
          if (!implicit) {
            var msg = "program exited (with status: " + status +
      ...
      class TreeCursor {
        ...
        get nodeIsNamed() {
          marshalTreeCursor(this);
          return C._ts_tree_cursor_current_node_is_named_wasm(this.tree[0]) ===
            1;
        }

        get nodeIsMissing() {
          marshalTreeCursor(this);
          return C._ts_tree_cursor_current_node_is_missing_wasm(
            this.tree[0],
          ) === 1;
        }
