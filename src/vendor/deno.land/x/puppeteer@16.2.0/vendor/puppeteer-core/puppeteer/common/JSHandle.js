...
export class JSHandle {
  ...
  async getProperties() {
    ...
    const response = await __classPrivateFieldGet(this, _JSHandle_client, "f")
      .send("Runtime.getProperties", {
        objectId:
          __classPrivateFieldGet(this, _JSHandle_remoteObject, "f").objectId,
        ownProperties: true,
      });
    ...
    for (const property of response.result) {
      ...
      result.set(
        property.name,
        createJSHandle(
          __classPrivateFieldGet(this, _JSHandle_context, "f"),
          property.value,
        ),
      );
    }
  ...
  async jsonValue() {
    if (!__classPrivateFieldGet(this, _JSHandle_remoteObject, "f").objectId) {
      return valueFromRemoteObject(
        __classPrivateFieldGet(this, _JSHandle_remoteObject, "f"),
      );
    }
  ...
  async dispose() {
    ...
    await releaseObject(
      __classPrivateFieldGet(this, _JSHandle_client, "f"),
      __classPrivateFieldGet(this, _JSHandle_remoteObject, "f"),
    );
  }
  /**
  ...
  toString() {
    ...
    const type =
      __classPrivateFieldGet(this, _JSHandle_remoteObject, "f").subtype ||
      __classPrivateFieldGet(this, _JSHandle_remoteObject, "f").type;
...
_JSHandle_client = new WeakMap(),
  _JSHandle_disposed = new WeakMap(),
  _JSHandle_context = new WeakMap(),
  _JSHandle_remoteObject = new WeakMap();
