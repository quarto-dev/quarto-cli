...
export class Coverage {
  constructor(client) {
    ...
    __classPrivateFieldSet(
      ...
      new JSCoverage(client),
      "f",
    );
    __classPrivateFieldSet(
      this,
      _Coverage_cssCoverage,
      new CSSCoverage(client),
      "f",
    );
  }
  /**
  ...
  async startJSCoverage(options = {}) {
    return await __classPrivateFieldGet(this, _Coverage_jsCoverage, "f").start(
      options,
    );
  }
  /**
  ...
  async startCSSCoverage(options = {}) {
    return await __classPrivateFieldGet(this, _Coverage_cssCoverage, "f").start(
      options,
    );
  }
  /**
  ...
  async stopCSSCoverage() {
    return await __classPrivateFieldGet(this, _Coverage_cssCoverage, "f")
      .stop();
  }
}
...
export class JSCoverage {
  ...
  async start(options = {}) {
    assert(
      !__classPrivateFieldGet(this, _JSCoverage_enabled, "f"),
      "JSCoverage is already enabled",
    );
    const {
      resetOnNavigation = true,
    ...
    __classPrivateFieldSet(this, _JSCoverage_eventListeners, [
      addEventListener(
        __classPrivateFieldGet(this, _JSCoverage_client, "f"),
    ...
    await Promise.all([
      __classPrivateFieldGet(this, _JSCoverage_client, "f").send(
        "Profiler.enable",
      ),
      __classPrivateFieldGet(this, _JSCoverage_client, "f").send(
        "Profiler.startPreciseCoverage",
        {
          callCount: __classPrivateFieldGet(
            this,
            _JSCoverage_includeRawScriptCoverage,
            "f",
          ),
  ...
  async stop() {
    ...
    removeEventListeners(
      __classPrivateFieldGet(this, _JSCoverage_eventListeners, "f"),
    );
    const coverage = [];
    const profileResponse = result[0];
    for (const entry of profileResponse.result) {
      let url = __classPrivateFieldGet(this, _JSCoverage_scriptURLs, "f").get(
        entry.scriptId,
      );
      if (
        !url &&
        __classPrivateFieldGet(this, _JSCoverage_reportAnonymousScripts, "f")
      ) {
        url = "debugger://VM" + entry.scriptId;
      }
      const text = __classPrivateFieldGet(this, _JSCoverage_scriptSources, "f")
        .get(entry.scriptId);
      ...
      if (
        !__classPrivateFieldGet(this, _JSCoverage_includeRawScriptCoverage, "f")
      ) {
...
_JSCoverage_client = new WeakMap(),
  _JSCoverage_enabled = new WeakMap(),
  _JSCoverage_scriptURLs = new WeakMap(),
  _JSCoverage_scriptSources = new WeakMap(),
  _JSCoverage_eventListeners = new WeakMap(),
  _JSCoverage_resetOnNavigation = new WeakMap(),
  _JSCoverage_reportAnonymousScripts = new WeakMap(),
  _JSCoverage_includeRawScriptCoverage = new WeakMap(),
  ...
  _JSCoverage_onScriptParsed = async function _JSCoverage_onScriptParsed(
    event,
  ) {
    ...
    try {
      const response = await __classPrivateFieldGet(
        ...
        _JSCoverage_client,
        "f",
      ).send("Debugger.getScriptSource", {
        scriptId: event.scriptId,
      });
      __classPrivateFieldGet(this, _JSCoverage_scriptURLs, "f").set(
        event.scriptId,
        event.url,
      );
      __classPrivateFieldGet(this, _JSCoverage_scriptSources, "f").set(
        event.scriptId,
        response.scriptSource,
      );
    } catch (error) {
...
export class CSSCoverage {
  ...
  async start(options = {}) {
    assert(
      !__classPrivateFieldGet(this, _CSSCoverage_enabled, "f"),
      "CSSCoverage is already enabled",
    );
    ...
    __classPrivateFieldSet(this, _CSSCoverage_eventListeners, [
      addEventListener(
        __classPrivateFieldGet(this, _CSSCoverage_client, "f"),
        "CSS.styleSheetAdded",
        __classPrivateFieldGet(
          this,
          _CSSCoverage_instances,
    ...
    await Promise.all([
      ...
      __classPrivateFieldGet(this, _CSSCoverage_client, "f").send(
  ...
  async stop() {
    assert(
      __classPrivateFieldGet(this, _CSSCoverage_enabled, "f"),
      "CSSCoverage is not enabled",
    );
    __classPrivateFieldSet(this, _CSSCoverage_enabled, false, "f");
    const ruleTrackingResponse = await __classPrivateFieldGet(
      this,
      _CSSCoverage_client,
      "f",
    ...
    removeEventListeners(
      __classPrivateFieldGet(this, _CSSCoverage_eventListeners, "f"),
    );
    ...
    const coverage = [];
    for (
      const styleSheetId of __classPrivateFieldGet(
        this,
        _CSSCoverage_stylesheetURLs,
        "f",
      ).keys()
    ) {
      const url = __classPrivateFieldGet(this, _CSSCoverage_stylesheetURLs, "f")
        .get(styleSheetId);
      assert(
        typeof url !== "undefined",
        `Stylesheet URL is undefined (styleSheetId=${styleSheetId})`,
      );
      const text = __classPrivateFieldGet(
        this,
        _CSSCoverage_stylesheetSources,
        "f",
      ).get(styleSheetId);
...
_CSSCoverage_client = new WeakMap(),
  _CSSCoverage_enabled = new WeakMap(),
  _CSSCoverage_stylesheetURLs = new WeakMap(),
  _CSSCoverage_stylesheetSources = new WeakMap(),
  _CSSCoverage_eventListeners = new WeakMap(),
  _CSSCoverage_resetOnNavigation = new WeakMap(),
  ...
  _CSSCoverage_onStyleSheet = async function _CSSCoverage_onStyleSheet(event) {
    ...
    try {
      ...
      __classPrivateFieldGet(this, _CSSCoverage_stylesheetURLs, "f").set(
        header.styleSheetId,
        header.sourceURL,
      );
      __classPrivateFieldGet(this, _CSSCoverage_stylesheetSources, "f").set(
        header.styleSheetId,
        response.text,
      );
    } catch (error) {
