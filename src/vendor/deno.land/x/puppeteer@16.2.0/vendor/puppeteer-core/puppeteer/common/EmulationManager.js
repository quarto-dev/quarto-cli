/// <reference types="./EmulationManager.d.ts" />
...
export class EmulationManager {
  ...
  async emulateViewport(viewport) {
    ...
    await Promise.all([
      __classPrivateFieldGet(this, _EmulationManager_client, "f").send(
    ...
    const reloadNeeded =
      __classPrivateFieldGet(this, _EmulationManager_emulatingMobile, "f") !==
        mobile ||
      __classPrivateFieldGet(this, _EmulationManager_hasTouch, "f") !==
        hasTouch;
