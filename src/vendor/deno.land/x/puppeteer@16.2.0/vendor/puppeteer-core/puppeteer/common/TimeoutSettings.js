/// <reference types="./TimeoutSettings.d.ts" />
/**
...
export class TimeoutSettings {
  constructor() {
    ...
    __classPrivateFieldSet(
      this,
      _TimeoutSettings_defaultNavigationTimeout,
      null,
      "f",
    );
  }
  ...
  navigationTimeout() {
    ...
    if (
      __classPrivateFieldGet(this, _TimeoutSettings_defaultTimeout, "f") !==
        null
    ) {
...
_TimeoutSettings_defaultTimeout = new WeakMap(),
  _TimeoutSettings_defaultNavigationTimeout = new WeakMap();
