/// <reference types="./FileChooser.d.ts" />
/**
...
export class FileChooser {
  ...
  async accept(filePaths) {
    assert(
      !__classPrivateFieldGet(this, _FileChooser_handled, "f"),
      "Cannot accept FileChooser which is already handled!",
    );
    __classPrivateFieldSet(this, _FileChooser_handled, true, "f");
    await __classPrivateFieldGet(this, _FileChooser_element, "f").uploadFile(
      ...filePaths,
    );
  }
  /**
...
_FileChooser_element = new WeakMap(),
  _FileChooser_multiple = new WeakMap(),
  _FileChooser_handled = new WeakMap();
