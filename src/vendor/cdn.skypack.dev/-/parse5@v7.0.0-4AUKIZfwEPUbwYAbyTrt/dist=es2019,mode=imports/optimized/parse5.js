import {htmlDecodeTree, determineBranch, BinTrieFlags} from "/-/entities@v4.3.0-V4vIlnoYfSBRg1gj9BOL/dist=es2019,mode=imports/optimized/entities/lib/decode.js";
import {escapeText, escapeAttribute} from "/-/entities@v4.3.0-V4vIlnoYfSBRg1gj9BOL/dist=es2019,mode=imports/optimized/entities/lib/escape.js";
  ...
  _leaveAttrName() {
    ...
    if (getTokenAttr(token2, this.currentAttr.name) === null) {
      ...
      if (token2.location && this.currentLocation) {
        const attrLocations = (_a = (_b = token2.location).attrs) !== null && _a !== void 0 ? _a : _b.attrs = Object.create(null);
