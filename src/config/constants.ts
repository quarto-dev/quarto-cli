...
export const kCalloutTipCaption = "callout-tip-localization";
export const kCalloutNoteCaption = "callout-note-localization";
export const kCalloutWarningCaption = "callout-warning-localization";
export const kCalloutImportantCaption = "callout-important-localization";
export const kCalloutCautionCaption = "callout-caution-localization";
